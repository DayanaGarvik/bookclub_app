...
def menu():
    ...
    while True:
        ...
        if user_input == "1":
            ...
            menu_search_by_rating(connection)
        elif user_input == "5":
...
# 4 - Find books by rating.
def menu_search_by_rating(connection):
    rating = input("Enter rating: ")
    print(" Book ID | Title | Author | Genre | Average Rating")
    db.search_by_ratings(connection, rating)
...
def menu_find_member(connection):
    ...
    print("Member name | Email | Number of books read")
